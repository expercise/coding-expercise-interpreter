...
public final class DockerHelper {
    ...
    private static final String EXPOSED_PORT = "4567";

    private static final Long MEMORY_CONSTRAINT = 5L * 1024 * 1024;
    ...
    // TODO ufuk: add other constraints
    public static String runNewContainer(String hostPort) {
        try {
            // Create container with exposed ports
            ContainerConfig containerConfig = ContainerConfig.builder()
                    .image(INTERPRETER_IMAGE_NAME)
                    .exposedPorts(new String[]{EXPOSED_PORT})
            ...
            portBindings.put(EXPOSED_PORT, Collections.singletonList(PortBinding.of("0.0.0.0", hostPort)));
